...
import { LayoutDashboard, Wallet, ArrowRightLeft, PiggyBank, LogOut, Hexagon, Plus, BarChart3, Settings } from "lucide-react";
    ...
    <aside className="w-64 bg-card border-r border-border h-screen sticky top-0 flex flex-col hidden md:flex">
      <div className="h-20 flex items-center px-6 border-b border-border/50">
        <div className="flex items-center gap-3 text-primary">
          <Hexagon className="w-8 h-8 fill-primary/10 stroke-[1.5]" />
          <span className="font-display font-bold text-xl text-foreground tracking-tight">Finova</span>
        </div>
      </div>
